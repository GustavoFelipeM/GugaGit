...
from src.git_manager import (
    branch_atual, executar_comando_livre, obter_config_git, salvar_config_git, status, fetch, criar_branch, adicionar, commit, push,
    listar_branches, trocar_branch, pull, clonar_repositorio, restaurar_alteracoes,
    deletar_branch, remover_staging, historico, diff, stash, stash_pop,
    listar_stash, merge, listar_tags, git_instalado
)
from src.config import obter_ultimo_repositorio, salvar_ultimo_repositorio
...
if __name__ == '__main__':
    ...
    def iniciar_app(window):
        api.aplicar_icone_nativo(icon_path)
